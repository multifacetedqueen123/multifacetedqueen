...
const services = [
  {
    ...
    icon: Scissors,
    tagline: "Styled by B",
    desc: "Natural hairstyles, custom braids & twists, protective styles, wig installs, and loc maintenance.",
    accent: "text-primary",
  ...
  },
  {
    ...
    tagline: "Handy Brandy",
    desc: "Expert tailoring and alterations — pants, shirts, suits, dresses, repairs, and rush fitting services.",
    accent: "text-secondary",
    border: "hover:border-secondary/60",
